...
```{r overview, cache = TRUE, eval = FALSE}
...
```{r params, cache = TRUE, eval = FALSE}
...
```{r untb_params, cache = TRUE, eval = FALSE}
...
```{r series, cache = TRUE, eval = FALSE}
...
```{r series2, cache = TRUE, eval = FALSE} 
...
```{r series3, cache = TRUE, eval = FALSE} 
